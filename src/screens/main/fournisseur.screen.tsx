...
import { CommandeV } from '../../components/commande/commande.component.v'
const ICON_SIZE=40
export const listE = [
    {title: "MODEM",
...
export class ListeProduitP extends Component{  
    
    render() {
        
        return (<View style={styles.container}>
            {listE.map((i: any) => (
         <CommandeV title={i.title} description={i.description} logo={i.logo} number={i.number} />
       ))}  
